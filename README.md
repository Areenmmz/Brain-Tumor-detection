...
* **Data Pre-processing:** Raw images are converted to grayscale, resized to a uniform $256 \times 256$ resolution, and normalized to a floating-point range (0 to 1) to ensure feature consistency across the dataset.
